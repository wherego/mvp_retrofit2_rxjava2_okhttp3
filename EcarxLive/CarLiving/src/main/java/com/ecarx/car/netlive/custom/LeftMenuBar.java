...
public class LeftMenuBar extends LinearLayout {
    ...
    private List<LeftMenuBarTab> mTabs = new ArrayList<>();
    ...
    public LeftMenuBar(Context context) {
        this(context, null);
    }

    public LeftMenuBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LeftMenuBar(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        addView(shadowView, new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
    ...
    public LeftMenuBar addItem(final LeftMenuBarTab tab) {
     ...
     * 获取 Tab
     */
    public LeftMenuBarTab getItem(int index) {
